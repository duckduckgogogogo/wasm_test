/**
   ...
   $Rev: 363 $
   $Date: 2008-08-06 17:23:25 +0200 (mer., 06 ao? 2008) $ 
   */
...
/**
   Compute the averaged nodal normals along a line mesh (2-D only).
   ...
   \warning       Edges should follow the same orientation (either all clockwise or all counter-clockwise). 
