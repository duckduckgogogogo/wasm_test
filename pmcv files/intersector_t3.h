/**
   ...
   $Rev: 363 $
   $Date: 2008-08-06 17:23:25 +0200 (mer., 06 août 2008) $ 
   */
...
/**
   ...
   This component finds out all the face-face intersections/overlappings 
   ...
   their distance is within a tolerance parameter (field of the operating_mode).
