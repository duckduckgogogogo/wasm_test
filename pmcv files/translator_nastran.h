...
/**
   ...
   $Rev: 364 $
   $Date: 2008-08-07 16:28:49 +0200 (jeu., 07 août 2008) $ 
   */
...
/**
   ...
   \warning       The current NASTRAN supported types are:
   ...
   \warning       Node and element IDs are -1 shifted from file (IDs start at 0 in CM2).
   */
...
/**
   ...
   \warning       The following CM2 types are converted to their NASTRAN serendipity closest type:
   ...
   \warning       Node and element IDs are +1 shifted on file (IDs start at 1 in NASTRAN).
   */
CM2MESHTOOLS_API int
NASTRAN_output
