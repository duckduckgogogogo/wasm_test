#ifndef __MESHER_TH4_ANISO_H__
#define __MESHER_TH4_ANISO_H__

/**
   \file       mesher_th4_aniso.h
   \brief      Definition of the unstructured anisotropic tetrahedral %mesher.
...
/**
   Unstructured anisotropic tetrahedral %mesher.

   \image html sphere_aniso1.png "Example of mesh generated by CM2 TetraMesh Aniso (clipping)."
   ...
   structure of type tetramesh_aniso::mesher::data_type.

   \note       Upon entry, the boundary faces in \ref data_type::connectB need to be oriented the same way
               when there are several subdomains to be meshed simultaneously, 
               or when internal cavities are present. 
   \note       Thread safe.
   \see        triamesh_aniso::mesher, tetramesh::mesher.
   */
class CM2TETRAMESH_ANISO_API mesher
{
public:
   ...
   /**
      The settings of tetramesh_aniso::mesher.

      This structure gathers flags and parameters to control the way the tetramesh_aniso::mesher works.
      */
   struct CM2TETRAMESH_ANISO_API settings_type
   {
   ...
   /**
      Resets to the \link cm2::tetramesh_aniso::mesher::settings_type::settings_type() default values \endlink.
      */
   void
   reset();
   ...
   /**
      The data type for tetramesh_aniso::mesher.

      This structure is used to gather all the input and output data of the function 
      tetramesh_aniso::mesher::run.
      */
   struct CM2TETRAMESH_ANISO_API data_type
   {
   ...
   /**
      ...
      This mesh generator is _3-D anisotropic_ and the metrics are 3x3 symmetric matrices.
     */
   typedef DoubleSym3         metric_type;

   /**
      The array type for the metric values.
      This mesh generator is _3-D anisotropic_ and the metrics are 3x3 symmetric matrices,
      represented as columns of 6 scalars (`double` values).
   ...
   /**
      ...
      Example:
      \code
         tetramesh_aniso::mesher             my_mesher;
         tetramesh_aniso::mesher::data_type  my_data(pos, connectB);  
   ...
   /**
      ...
      \note    The indices refer to columns in the coordinates matrix \ref pos.
      \note    Only repulsive points associated to a valid metric (i.e. positive-definite columns in
               the \ref metrics matrix) are taken into account.
      \note    Not used in settings_type::CONVEX_HULL_MODE.
   ...
   /**
      ...
      \note       For 3-D anisotropic meshes, it is recommended to provide a background mesh (and,
                  of course, valid 3-D metrics at its nodes).
   ...
   /**
      Nodal metrics as a matrix of dimension 6 x \ref nods.
   ...
   /*
      Irrelevant. Should not be used (provided for compatibility with cm2::tetramesh::mesher::data_type).
      Mode = OUT.
      */
...
/**
   ...
   See \link cm2::tetramesh_aniso::mesher::settings_type::settings_type() default settings \endlink.
   */
mesher();
...
/**
   ...
   \see  tetramesh_aniso::registration.
   */
static bool
authorized();
