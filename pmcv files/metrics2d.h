...
/**
   Interpolates a field of isotropic metrics defined on a planar triangle mesh.
...
interpolate_metrics 
   (const DoubleMat& pos, 
    const UIntMat& connectT3, const UIntMat& neighbors, const UIntVec& ancestors,
...
/**
   Interpolates a field of 2-D or 3-D anisotropic metrics defined on a planar triangle mesh.
