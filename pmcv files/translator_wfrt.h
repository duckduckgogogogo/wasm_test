...
/**
   Wavefront obj output of a mesh with possibly normals and textures.

   \param[in]     filename          The file name.
   \param[in]     pos               The coordinates matrix.
   \param[in]     normals           The normals at the vertices, if any. 
   \param[in]     textures          The textures at the vertices, if any. 
