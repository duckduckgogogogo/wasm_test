#ifndef __MESHER_Q4_ANISO_H__
#define __MESHER_Q4_ANISO_H__

/**
   \file       mesher_q4_aniso.h
   \brief      Definition of the unstructured anisotropic quad %mesher.
...
/**
   Unstructured anisotropic quadrangle %mesher (all-quad and mixed triangle/quad mesh generator).

   \image html tmsh2da54_qt.png "Example of mesh generated by CM2 QuadMesh Aniso (2D mesh with anisotropic metrics)."
   ...
   structure of type quadmesh_aniso::mesher::data_type.
   ...
   quadmesh_aniso::mesher   my_mesher;
   my_mesher.run(data);
   ...
   \see        meshtools2d::mesh_struct_Q4, quadmesh::mesher, triamesh_aniso::mesher.
   */
class CM2QUADMESH_ANISO_API mesher
{
public:
   ...
   /**
      The settings of quadmesh_aniso::mesher.

      This structure gathers flags and parameters to control the way the quadmesh_aniso::mesher works.
      */
   struct CM2QUADMESH_ANISO_API settings_type
   {
   ...
   { 
      ...
      CONVEX_HULL_MODE          //!< Produces an approximate convex hull of a set of points (_triangles_ only).
   };
   ...
   /**
      Resets to the \link cm2::quadmesh_aniso::mesher::settings_type::settings_type() default values \endlink.
      */
   void
   reset();
   ...
   /**
      ...
      \warning Disabled when target_metric is not positive-definite.
   ...
   /**
      The data type for quadmesh_aniso::mesher.

      This structure is used to gather all the input and output data of the function 
      quadmesh_aniso::mesher::run.
      */
   struct CM2QUADMESH_ANISO_API data_type
   {
   ...
   /**
      ...
      \code
         quadmesh_aniso::mesher              my_mesher;
         quadmesh_aniso::mesher::data_type   my_data(pos, connectB);  
   ...
   /**
      ...
      \note    Only repulsive points associated to a valid metric (i.e. positive-definite column in
               matrix \ref metrics) are taken into account.
   ...
   /**
      Nodal metrics as a matrix of dimension 3xN.
...
/**
   ...
   See \link cm2::quadmesh_aniso::mesher::settings_type::settings_type() default settings \endlink.
   */
mesher();
